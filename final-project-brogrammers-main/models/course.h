...
/*!
 * \brief   In this class, there are all features and relations between Courses and All members in the learning Process
 */
...
public:
    ...
    void set_students_to_grades(Student* student , float grade);
};
