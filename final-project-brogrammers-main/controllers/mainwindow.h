...
/*!
 * \brief   In this class, there are all processes and actions all over the program
 */
...
private slots:
   ...
   void on_tbl_admins_cellClicked(int row, int column);
    ...
    void on_btn_stud_view_clicked();

    void on_btn_prof_view_clicked();
    ...
    void on_btn_view_sel_student_clicked();



   //void on_btn_delete_sel_student_clicked();

    void on_tbl_students_4_cellClicked(int row, int column);

    void on_btn_delete_sel_student_clicked();

    void on_btn_delete_sel_professor_clicked();

    void on_tbl_professors_5_cellClicked(int row, int column);

    void on_btn_view_sel_professor_clicked();
